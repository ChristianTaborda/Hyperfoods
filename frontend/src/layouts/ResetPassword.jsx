    ...
    axios
      ...
      .catch((e) => {
        ...
        if (e.response.data.non_field_errors[0]) {
            ...
            notify("br", "danger", "We're having some problems, please try later");
        }
        setTimeout(() => {resetForm({ email: "",});}, 600);
      });
  };
    ...
    return (
      <div className="login-background">
        ...
        /** SI ES UN LINK CON PARAMETROS*/
            ...
            onSubmit={(values, { resetForm }) => onSubmitChange(values, { resetForm })}>
            <Form className="login-form shadow p-4 mb-0 rounded">
            {showField? 
            <>
            <p className="text-dark pt-4">Please type your new password
            </p>
        ...
        >
          <Form className="login-form shadow p-4 mb-0 rounded">
            ...
            <p className="text-dark pt-4">Enter your email account and we'll send you a message 
            with instructions,  you can then check it and reset your password
            </p>
            {loading ? <div className="loader" /> : null}
            <br />
            {showField? 
            ...
            : 
            <p className="text-dark pt-2 h4">
                <b>We send you a message, please check your email to continue.</b>
            </p>
            }
            <div className="text-center">
              <br/><a href="/">Return</a>
