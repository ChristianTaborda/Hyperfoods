                      ...
                      axios
                       ...
                       .then(
                         (res) => {
                           ...
                           .then(
                             (res) => {setTopSellingWorkers(res.data) 
                                 setLoading(false) 
                                }
                           )
                  ...
                  <Card>
                    <CardBody>
                      ...
                      <Table  className="tablesorter text-center">
                        ...
                        <tbody>
                            {CustomerWithMorePurchases.report ===undefined ? null :
                            CustomerWithMorePurchases.report.map((customer, i) => {
                                              return (
                                                <tr key={i}>
                  ...
                  <Card>
                    <CardBody>
                      ...
                      <Table  className="tablesorter text-center">
                        ...
                        <tbody>
                            {AddressesWithMostSales.report ===undefined ? null :
                            AddressesWithMostSales.report.map((adresse, i) => {
                                              return (
                                                <tr key={i}>
                                                  <td>{adresse.zone}</td>
                  ...
                  <Card>
                    <CardBody>
                      ...
                      <Table  className="tablesorter text-center">
                        ...
                        <tbody>
                            {topSellingWorkers.report ===undefined ? null :
